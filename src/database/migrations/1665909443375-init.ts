...
export class init1665909443375 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "examination" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "examinationDate" date NOT NULL, "mileage" numeric(8) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "motorVehicleId" uuid, CONSTRAINT "PK_de7c2a81d379fdf37174356fc12" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `ALTER TABLE "motor_vehicle" ADD CONSTRAINT "FK_25bd76e676ded70eac2564a51ea" FOREIGN KEY ("motorVehicleOwnerId") REFERENCES "motor_vehicle_owner"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "examination" ADD CONSTRAINT "FK_c8cea02f1e872ae580113ff53fc" FOREIGN KEY ("motorVehicleId") REFERENCES "motor_vehicle"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "examination" DROP CONSTRAINT "FK_c8cea02f1e872ae580113ff53fc"`
    );
    await queryRunner.query(
      `ALTER TABLE "motor_vehicle" DROP CONSTRAINT "FK_25bd76e676ded70eac2564a51ea"`
    );
    await queryRunner.query(`DROP TABLE "examination"`);
    await queryRunner.query(`DROP TABLE "motor_vehicle"`);
    await queryRunner.query(
      `DROP TYPE "public"."motor_vehicle_motorvehicletype_enum"`
    );
